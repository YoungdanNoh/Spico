...
val DummyRandomSpeechReady = RandomSpeechInitInfo(
    ...
    newsUrl = "https://m.sports.naver.com/kbaseball/article/109/0005300750",
    newsSummary = "최근 AI 기술의 급격한 발전으로 인해 반복적인 업무를 중심으로 일자리가 대체되고 있습니다. 이에 따라 미래 직업의 변화와 교육 방향에 대한 논의가 활발하게 이루어지고 있습니다."
)
