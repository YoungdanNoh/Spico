...
@Order(2)
class RandomSpeechExceptionHandler {

    private val logger = LoggerFactory.getLogger(RandomSpeechExceptionHandler::class.java)
    @ExceptionHandler(RandomSpeechException::class)
    fun handleRandomSpeechException(exception: RandomSpeechException): ApiResponse<Any?> {
